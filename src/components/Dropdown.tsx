...
function Dropdown({ options, name, liftSelectedOptionUp }: Props) {
    ...
    return (
        <div>
            <div className='fg-item flex items-center justify-items-center flex-row-reverse h-8 w-60 border focus:ring-blue-700 focus:border-blue-700' onClick={ handleMenuClick } ref={ ref }>
