...
function LoginRegisterModal() {
    const { accountModalVisible: visible, setAccountModalVisible: setVisible } = useContext(AccountModalContext)!;
    ...
    return (
        <div className="justify-items-center fixed top-0 bottom-0 left-0 right-0 z-50 flex items-center w-screen h-screen overflow-y-auto bg-black bg-opacity-50">
            <div ref={ modalRef } className="fg-item sm:w-96 relative w-3/4 px-10 py-4 m-auto text-center select-none">
